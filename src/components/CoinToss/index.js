...
class CoinsToss extends Component {
  state = {TossImageResult: HEADS_IMG_URL, headsCount: 0, tailsCount: 0}
  ...
  render() {
    const {TossImageResult, headsCount, tailsCount} = this.state
    ...
    return (
      <div className="app-container">
        <div className="card-container">
          ...
          <img src={TossImageResult} alt="toss result" className="image" />
